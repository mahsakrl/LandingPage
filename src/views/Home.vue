      ...
      <div class="greyish-bg">
        <div class="shorten-list">
          <div v-for="(item,index) in result" :key="index" class="search-result">
            ...
            <div style="display:flex;align-items:center;color:hsl(180, 66%, 49%);">
              <div>short link</div>
              <div>
                <button
                  style="border-radius:8px;width:80px;height:30px;margin-right:20px;margin-left:20px"
                  v-if="!copied"
                >copy</button>
                <button
                  style="border-radius:8px;width:80px;height:30px;background-color:navy;margin-right:20px;margin-left:20px"
                  v-if="copied"
                >copied</button>
              </div>
            </div>
